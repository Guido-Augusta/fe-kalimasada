...
export default function SantriProfileCard({
  santriData,
  baseUrl,
  role,
  onUpdateHafalanClick,
  ...
  } = useChartData(String(santriData.id), chartRange, chartMode);
            ...
            <CardHeader className="text-center">
              ...
              <div className="flex justify-between items-center mt-2">
                ...
                <p className="text-sm font-semibold">
                  {formatTahapHafalan(santriData.tahapHafalan)}
                </p>
              </div>
              <div className="flex justify-between items-center mt-2">
                <p className="text-sm font-semibold text-muted-foreground">
                      ...
                      >
                        ...
                        <Link to={`${baseUrl}/ustadz/detail/${item.id}`}>
                          <Button
                            variant="outline"
                            size="sm"
                            className="flex items-center gap-2 bg-green-500 hover:bg-green-600 hover:text-white text-white"
                          >
