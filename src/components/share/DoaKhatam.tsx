...
export default function DoaKhatam() {
  return (
    <Card className="p-4 border border-violet-600/90">
      ...
      <p className="text-left text-base text-green-600 italic">Arab latin: Allahummarhamna bil Qur’an Waj’alhu lana imaaman wa nuuron wa hudan wa rohmah, Allahumma dzakkirna minhu maa nasiina Wa’allimna minhumaa jahiilna Warzuqna tilaawatahu Aana allaili wa athrofannahar Waj’alhulana hujjatan Yaaa Robbal ‘alamiin</p>
