...
import UstadzAddHafalanJuz from '@/features/ustadz/pages/UstadzAddHafalanJuz';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          element={
            <PrivateRoute allowedRoles={['admin']} redirectPath="/login" />
          }
        >
          ...
          <Route
            path="/admin/santri/peringkat"
            element={<AdminPeringkatSantri />}
          />
          <Route path="/admin/alquran" element={<AlquranAdmin />} />
          <Route
            path="/admin/alquran/surah/:idSurah"
            element={<BacaAlquranAdmin />}
          />
        ...
        <Route element={<PrivateRoute allowedRoles={['ustadz']} />}>
          ...
          <Route
            path="/ustadz/santri-detail/:id"
            element={<UstadzDetailSantri />}
          />
          <Route
            path="/ustadz/orangtua/detail/:id"
            element={<UstadzDetailOrtu />}
          />
          <Route
            path="/ustadz/progress/hafalan/:idSantri"
            element={<UstadzProgressHafalan />}
          />
          <Route
            path="/ustadz/hafalan/:idSantri/:idSurah"
            element={<UstadzAddHafalan />}
          />
          <Route
            path="/ustadz/hafalan/:idSantri/juz/:idJuz"
            element={<UstadzAddHafalanJuz />}
          />
          <Route
            path="/ustadz/riwayat/hafalan/:idSantri"
            element={<UstadzRiwayatHafalan />}
          />
          <Route
            path="/ustadz/riwayat/detail/:santriId/surah/:surahId"
          ...
          <Route
            path="/ustadz/alquran/surah/:idSurah"
            element={<BacaSurahUstadz />}
          />
          <Route
            path="/ustadz/alquran/juz/:idJuz"
            element={<BacaJuzUstadz />}
          />
          <Route
            path="/ustadz/change-password"
            element={<UstadChangePassword />}
          />
          <Route
            path="/ustadz/ustadz/detail/:id"
            element={<UstadLainDetail />}
          />
          <Route path="/ustadz/kelas/tahapan" element={<UstadKelasTahapan />} />
          <Route
            path="/ustadz/riwayat/terakhir"
            element={<UstadRiwayatTerakhir />}
          />
        </Route>
        ...
        <Route element={<PrivateRoute allowedRoles={['ortu']} />}>
          ...
          <Route
            path="/ortu/santri-detail/:id"
            element={<OrtuDetailSantri />}
          />
          <Route
            path="/ortu/orangtua/detail/:id"
            element={<OtherParentDetail />}
          />
          <Route
          ...
          <Route
            path="/ortu/alquran/surah/:idSurah"
            element={<BacaAlquranOrtu />}
          />
          <Route path="/ortu/alquran/juz/:idJuz" element={<BacaJuzOrtu />} />
          <Route
            path="/ortu/change-password"
            element={<OrtuChangePassword />}
          />
        ...
        <Route element={<PrivateRoute allowedRoles={['santri']} />}>
          ...
          <Route
            ...
            element={<SantriDetailView />}
          />
          <Route
            path="/santri/orangtua/detail/:id"
          ...
          />
          <Route
            path="/santri/doa-khatam-al-quran"
            element={<DoakKhatamSantri />}
          />
        </Route>
